...
# Model: Mistral-7B-Instruct-v0.3, 4 GPUs (0-3)
# Usage: bash baseline/GRPO/run_grpo_search_r1_like_mistral_7b.sh
...
save_path="/mnt/workspace/checkpoints/search_r1_like_grpo_sglang_mistral-7b-instruct-v0.3_asearcher"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=mistralai/Mistral-7B-Instruct-v0.3\
    ...
    trainer.experiment_name='mistral-7b-instruct-v0.3-grpo-vllm-async-toolagent-n5-8gpu' \
