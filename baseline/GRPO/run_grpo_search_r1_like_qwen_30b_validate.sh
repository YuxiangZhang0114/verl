...
save_path="/mnt/workspace/checkpoints/search_r1_like_grpo_sglang_qwen3-30"
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='val_on_train_samples_qwen3-30b_instruct-grpo_hotpotqa_f1_2048samples_preliminary' \
